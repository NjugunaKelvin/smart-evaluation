...
export default function PatronRegisterPage() {
    ...
    const handleNext = () => {
        if (step === 1) {
            ...
            if (!formData.orgName || !formData.type) {
                alert("Please fill in all required fields.");
                return;
            }
        }
        ...
        <div className="flex min-h-screen bg-gray-50">
            ...
            <div className="flex-1 flex flex-col justify-center px-6 md:px-12 lg:px-16 relative z-10">
                <div className="max-w-md w-full mx-auto">
                    <Link href="/patron/login" className="inline-flex items-center text-sm text-gray-500 hover:text-purple-600 transition-colors mb-8 group">
                    ...
                    <div className="mb-8">
                        ...
                        <p className="text-gray-600 text-sm font-medium">
                            {step === 1 && "Create a patron account to manage grants and projects."}
                            {step === 2 && "Tell us about the entity you represent."}
                            {step === 3 && "Define the areas where you want to make an impact."}
                        </p>
                    </div>
                        ...
                        <AnimatePresence mode="wait">
                            {step === 1 && (
                                ...
                                >
                                    ...
                                    {formData.password && (
                                        <div className="space-y-1">
                                            <div className="flex justify-between text-xs">
                                                ...
                                                <span className={`font-medium ${passwordStrength <= 2 ? 'text-red-500' : passwordStrength === 3 ? 'text-yellow-600' : 'text-green-600'}`}>
                                                    {getStrengthText()}
                                                </span>
                                            </div>
                                    ...
                                    <Button type="button" onClick={handleNext} className="w-full py-3.5 text-sm font-bold rounded-xl text-white bg-purple-700 hover:bg-purple-800 transition-colors shadow-lg shadow-purple-700/20">
                                        Continue
                                    </Button>
                                </motion.div>
                            )}
                            ...
                            {step === 2 && (
                                ...
                                >
                                    ...
                                    <div className="flex space-x-3">
                                        ...
                                        <Button type="button" onClick={handleNext} className="flex-1 py-3.5 text-sm font-bold rounded-xl text-white bg-purple-700 hover:bg-purple-800 transition-colors shadow-lg shadow-purple-700/20">
                                            Continue
                                        </Button>
                                    </div>
                                </motion.div>
                                ...
                                >
                                    <div>
                                        <label className="block text-sm font-medium text-gray-700 mb-3">
                                            Select primary impact focus areas:
                                        </label>
                                        <div className="grid grid-cols-2 gap-3">
                                            {focusAreas.map((area) => (
                                                <button
                                                    ...
                                                    className={`p-3 text-xs font-medium rounded-xl border transition-all duration-200 text-left ${formData.focusAreas.includes(area)
                                    ...
                                    <div className="flex items-start space-x-3 pt-2">
                                        ...
                                        <label className="text-xs text-gray-600 leading-tight">
                                            I agree to the {' '}
                                            <Link href="/terms" className="text-purple-600 font-medium hover:underline">Patron Terms</Link>{' '}
                                            and{' '}
                                    ...
                                    <div className="flex space-x-3">
                                        ...
                                        <Button type="submit" disabled={loading} className="flex-1 py-3.5 text-sm font-bold rounded-xl text-white bg-purple-700 hover:bg-purple-800 transition-colors shadow-lg shadow-purple-700/20 disabled:opacity-70">
                    ...
                    <div className="mt-8 pt-6 border-t border-gray-100">
                        <p className="text-center text-sm text-gray-600">
                            ...
                            <Link href="/patron/login" className="text-purple-600 font-bold hover:underline">Sign in</Link>
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div className="hidden lg:block lg:w-1/2 relative overflow-hidden bg-gray-900">
                ...
                <img
                    ...
                    alt="Patron portal visual"
                    className="w-full h-full object-cover opacity-60"
                />
                <div className="absolute inset-0 z-20 flex flex-col justify-end p-16 text-white">
                    <h2 className="text-4xl font-bold mb-4 leading-tight">Drive Global Change</h2>
                    <p className="text-lg text-gray-200 max-w-md">
                        Join a network of visionary organizations transforming funding into measurable progress.
                    </p>
                </div>
            </div>
        </div>
